...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "atmospheric_correction/SIAC")))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "atmospheric_correction")))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "gp_emulator/gp_emulator")))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "gp_emulator")))
...
# from sar_pre_processing.version import __version__
# version = __version__  # Is set by calling `setup.py docs`
version = 'to_be_set'
...
try:
    from sar_pre_processing import __version__ as version
except ImportError:
    pass
else:
    release = version
...
latex_documents = [
  ('index', 'MULTIPLYDoc.tex', u'MULTIPLY Doc',
